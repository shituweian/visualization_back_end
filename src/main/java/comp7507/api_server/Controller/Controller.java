...
public class Controller {
    ...
    public List getCalendarData()
    {
        ...
        oneMonth = new ArrayList();
        oneYear = new ArrayList();
        String roadSql = "SELECT Date, Year, Wet_or_damp as Damp, Dry, Frost_or_ice as Frost, " +
        ...
        oneMonth = new ArrayList();
        oneYear = new ArrayList();
        String weatherSql = "SELECT Date, Year, Raining_no_high_winds, Fine_no_high_winds, Snowing_no_high_winds, " +
